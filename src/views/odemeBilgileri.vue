<template>
    ...
    <form method="post" action="#" @submit.prevent="odeme_yap">
        <p><b>Toplam Tutar: </b> {{toplamTutar}} TL</p>
    <div class="row">
        <div class="col-2">
        ...
        <button class="btn btn-success float-right mt-3" @click="odeme_yap()">Odeme Yap</button>
    </form>
    </div>
</template>
...
<script>
    ...
    export default {
        ...
        computed:{
            toplamTutar(){
               return this.secilen_sefer.bilet_fiyati * this.secilen_koltuklar.lenght;
            }
        },
        created(){
